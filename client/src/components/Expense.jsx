...
function Expense({
  ...
  //component code from mui Accordian component
  ...
  return (
    <Box display="flex" alignItems="center" flexDirection="row" width="100%">
      ...
      >
        ...
        <Divider />
        <AccordionDetails>
          <Typography pb="15px">{`Amount : ${amount}`}</Typography>
          <Divider />
          <Typography pt="5px">{`Description : ${description}`}</Typography>
        </AccordionDetails>
      </Accordion>
      <Tooltip title="Edit Expense" placement="left-start">
        <IconButton onClick={() => handleEditClick(id)} color="secondary">
          <EditIcon />
        </IconButton>
      </Tooltip>
      <Tooltip title="Delete Expense" placement="right-start">
        <IconButton onClick={() => deleteExpense(id)} color="secondary">
          <DeleteIcon />
        </IconButton>
      </Tooltip>
    </Box>
